...
const BuyGuide = () => {
  return (
    <div className="BuyGuide w-full ml:w-[530px] mx-auto ">
      <div className="Container  bg-red-300 mx-auto px-[20px]">
        <div className="TitleButton  ">
          <h4 className="font-[VasirBold] text-[18px] px-[15px] ">
        ...
        <div className="Cards">
          <div className="card1">
            <div className="cardContent group w-full p-[30px] bg-blue-300 mx-auto rounded-t-lg ">
              <div className="head text-[#D93E40] text-[15px] font-[IranSans]">
                خبر جدید
              </div>
              <div className="title hover: underlinTitr">
                <a className="text-[15px] font-[VasirBold]">
            ...
            <div className="cardImage group overflow-hidden flex justify-center rounded-b-lg relative">
              <Image
                src={card1}
                alt={""}
                className="w-full rounded-b-lg group-hover:scale-110 transition duration-300"
              />
              <div className="w-[41px] h-[42px] absolute top-[20%] left-[80%] bg-red-500 mb-[10px] flex justify-center items-center rounded-lg transform -translate-x-1/2 -translate-y-[50%]">
                <span className="w-[25px] h-[25px] text-center text-white font-[VasirBold]">8.1</span>
              </div>
            </div>
          </div>
          <div className="card2 mt-[30px] w-full">
            <div className="cardContent  group p-[30px] bg-blue-300 mx-auto rounded-t-lg ">
              <div className="head text-[#D93E40] text-[15px] font-[IranSans]">
                خبر جدید
              </div>
              <div className="title hover: underlinTitr">
            ...
            <div className="cardImage group overflow-hidden  flex justify-center rounded-b-lg relative">
              ...
              />
              <div className="w-[41px] h-[42px] absolute top-[20%] left-[80%] bg-red-500 mb-[10px] flex justify-center items-center rounded-lg transform -translate-x-1/2 -translate-y-[50%]">
                <span className="w-[25px] h-[25px] text-center text-white font-[VasirBold]">8</span>
              </div>
            </div>
          </div>
          <div className="card3 ml:flex ml:items-center md:items-end lg:items-center lg:mt-[30px]">
            ...
            ml:rounded-lg ml:h-[222px] md:w-[375px] lg:h-[236px] lg:py-0 xl:mr-0"
            >
          ...
          <div className="card6 ml:flex ml:items-center md:items-end lg:items-center lg:mt-[30px]">
            <div
              className="Image6 group mt-[30px] rounded-lg relative overflow-hidden ml:w-[153px] ml:h-[252px] md:w-[295px] md:h-[284px]
            lg:h-[236px] lg:mt-0"
            >
              <Image
                src={card6}
            ...
            <div
              className="PostContent6 px-[20px] border-b border-r border-l border-[#837f7f] rounded-b-lg py-[32px]  w-full ml:mr-[20px] ml:w-[337px] ml:border-t 
            ml:rounded-lg ml:h-[222px] md:w-[375px] lg:h-[236px] lg:py-0 xl:mr-0"
            >
              <span className="font-[IranSans] text-[15px] text-[#D93E40] hover:text-[#3858f6]">
                موبایل
        ...
        <div className="Sidebar">
          ...
          <div className="MostPUpulerVideo">
            <div>
              <h5 className="text-center font-[VasirBold] border-b border-[#000000] w-[250px] mx-auto mb-[20px] pb-[7px]">
                پربازدیدترین ویدئوها
              </h5>
            </div>
            <div className="widget1 w-full md:w-[360px] lg:w-[240px] lg:h-[303px] lg:mt-[30px] xl:w-[300px] mx-auto">
              <div className=" Container group w-full md:w-[330px] relative overflow-hidden rounded-lg  mx-auto  lg:w-[240px] xl:w-[270px] ">
                <Image
                  src={widget1}
                  alt={""}
                  className=" group-hover:scale-110 transition duration-300 rounded-lg  md:w-[330px]  lg:w-[210px] xl:w-[270px] w-full "
                />
              ...
              <div className="Content mt-[15px] mx-auto">
                <h3 className="mb-[10px] text-[16px] font-[VasirBold] px-[15px] md:w-[350px] lg:w-fit underlinTitr after:!bg-white w-[full] mx-auto">
                  بررسی لپ تاپ هواوی میت بوک D 14 [با بررسی ویدئویی]
                </h3>
              </div>
            </div>

            <div className="widget2 w-full md:w-[360px] lg:w-[240px] lg:h-[303px] lg:mt-[30px] xl:w-[300px] mx-auto">
            <div className=" Container group w-full md:w-[330px] relative overflow-hidden rounded-lg  mx-auto  lg:w-[240px] xl:w-[270px] ">
              <Image
                src={widget2}
                alt={""}
                className=" group-hover:scale-110 transition duration-300 rounded-lg  md:w-[330px] w-full  lg:w-[210px] xl:w-[270px]  "
              />
              <div className="w-[50px] h-[50px] PostContent  absolute top-[50%] left-1/2 bg-red-500 transform -translate-x-1/2 -translate-y-[50%] px-[20px] pb-[20px] mb-[10px] flex justify-center items-center  rounded-[50%]">
                <Play className="mb-[10px]  absolute top-[15px]  right-[15px]" />
              </div>
          ...
          <div className="widget3 w-full md:w-[360px] lg:w-[240px] lg:h-[303px] lg:mt-[30px] xl:w-[300px] mx-auto">
            <div className=" Container group w-full md:w-[330px] relative overflow-hidden rounded-lg  mx-auto  lg:w-[240px] xl:w-[270px] ">
              <Image
                src={widget3}
                alt={""}
            ...
            <div className="Content mt-[15px] mx-auto">
              <h3 className="mb-[10px] text-[16px] font-[VasirBold] px-[15px] md:w-[350px] lg:w-fit underlinTitr after:!bg-white  mx-auto w-full">
              بررسی آیپد پرو 2021 اپل [با بررسی ویدئویی]
              </h3>
            </div>
          </div>
          </div>
          <div className="Banner pt-[30px] pb-[40px] bg-slate-400">
