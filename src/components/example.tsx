  ...
  return (
    <div className="Posts w-full  h-[1500px] lg:h-auto bg-[#f0f2f5]  pt-[30px] flex justify-center xl:block">
      <div className="Container flex">
        <div className="RightPost group w-[260px] md:w-full relative overflow-hidden rounded-lg md:px-[15px]  xl:w-[40%]">
          <Image
            src={RightPost}
            alt={"تولید محتوا"}
        ...
        <div className="CenterPost flex flex-wrap w-[50%]">
          ...
          <div className="group w-[260px] md:w-[360px] relative overflow-hidden rounded-lg mt-[30px] md:mt-0  md:px-[15px] lg:w-[480px]  xl:w-[300px] ">
            <Image
              src={Post2}
              alt={""}
              className=" group-hover:scale-110  md:w-full transition duration-300  rounded-lg"
          ...
          <div className="group w-[260px]  md:w-[360px] relative overflow-hidden rounded-lg mt-[30px]  md:px-[15px] lg:w-[480px] xl:w-[300px] ">
            <Image
              src={Post3}
              alt={""}
              className=" group-hover:scale-110 md:w-full transition duration-300 rounded-lg "
