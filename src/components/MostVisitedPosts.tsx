...
const MostVisitedPosts = () => {
  return (
    <div className="MostVisitedPosts w-full h-[1200px] flex justify-center bg-white lg:h-auto">
      <div className="Container w-[320px] md:w-[720px] lg:w-[960px] px-[15px]  mx-auto ">
        <div className="Title  md:flex justify-between items-baseline">
          <div className="Section w-[290px]  mx-auto">
            <h3 className="font-[VasirBold] md:w-[480px] md:text-[28px] lg:text-[20px]"> پربازدید ترین مطالب</h3>
          </div>
          <div className="w-[290px] h-[32px] mt-[20px]  mx-auto text-left lg:mr-[400px]">
        ...
        <div className=" w-[300px] md:w-full  h-[1101px] lg:h-auto flex-col ">
          ...
          <div className="Posts w-[290px]  h-[650px]  lg:w-[960px]  lg:flex">
            <div className="StartPost lg:w-[480px] ">
            ...
            <div className="LastPost group w-[290px]  h-[246px] md:w-[690px] md:h-[587px] lg:w-[480px] lg:h-[488px] mt-[40px] relative overflow-hidden rounded-lg ">
              <Image
                src={lastPost}
                alt={" اپل"}
              ...
              lg:top-[65%] lg:left-[70%]">
                <h2 className="text-[15px]"> برند اپل</h2>
                <p className="text-[20px]  hover:underline delay-1000 w-[240px] md:w-[490px] lg:w-[360px]">
